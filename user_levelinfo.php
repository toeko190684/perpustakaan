...
//
class cuser_level extends cTable {
	var $UserLevelID;
	var $UserLevelName;
	...
	function __construct() {
		...
		// UserLevelID
		$this->UserLevelID = new cField('user_level', 'user_level', 'x_UserLevelID', 'UserLevelID', '`UserLevelID`', '`UserLevelID`', 3, -1, FALSE, '`UserLevelID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->UserLevelID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['UserLevelID'] = &$this->UserLevelID;

		// UserLevelName
		$this->UserLevelName = new cField('user_level', 'user_level', 'x_UserLevelName', 'UserLevelName', '`UserLevelName`', '`UserLevelName`', 200, -1, FALSE, '`UserLevelName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`user_level`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("user_levelview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("user_levelview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "user_leveladd.php?" . $this->UrlParm($parm);
		else
			return "user_leveladd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("user_leveledit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("user_leveladd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("user_leveldelete.php", $this->UrlParm());
	}
