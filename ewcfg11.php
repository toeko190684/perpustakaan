...
define("EW_PROJECT_ID", "{6362B67B-391D-4CF2-AF36-D4D235D92D64}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'p2XwwlvffMo3xx7j', TRUE); // Random key for encryption
...
define("EW_CONN_PASS", 'm0r1n@g@', TRUE);
define("EW_CONN_DB", 'perpustakaan', TRUE);
...
define("EW_USER_NAME_FILTER", "(`user_id` = '%u')",  TRUE);
