...
class cusers_list extends cusers {
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->activated, $arKeywords, $type);
		return $sWhere;
	}
...
<?php if ($users->user_id->Visible) { // user_id ?>
	<?php if ($users->SortUrl($users->user_id) == "") { ?>
		<th data-name="user_id"><div id="elh_users_user_id" class="users_user_id"><div class="ewTableHeaderCaption"><?php echo $users->user_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->user_id) ?>',1);"><div id="elh_users_user_id" class="users_user_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->user_id->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($users->user_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->user_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($users->level->Visible) { // level ?>
	<?php if ($users->SortUrl($users->level) == "") { ?>
		<th data-name="level"><div id="elh_users_level" class="users_level"><div class="ewTableHeaderCaption"><?php echo $users->level->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="level"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->level) ?>',1);"><div id="elh_users_level" class="users_level">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->level->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($users->level->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->level->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($users->activated->Visible) { // activated ?>
	...
	<?php } else { ?>
		<th data-name="activated"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->activated) ?>',1);"><div id="elh_users_activated" class="users_activated">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->activated->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($users->activated->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->activated->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<?php echo $users->password->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($users->level->Visible) { // level ?>
		<td data-name="level"<?php echo $users->level->CellAttributes() ?>>
