...
class cuser_level_permission extends cTable {
	...
	function __construct() {
		...
		// UserLevelID
		$this->UserLevelID = new cField('user_level_permission', 'user_level_permission', 'x_UserLevelID', 'UserLevelID', '`UserLevelID`', '`UserLevelID`', 3, -1, FALSE, '`UserLevelID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->UserLevelID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['UserLevelID'] = &$this->UserLevelID;

		// TableName
		$this->_TableName = new cField('user_level_permission', 'user_level_permission', 'x__TableName', 'TableName', '`TableName`', '`TableName`', 200, -1, FALSE, '`TableName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TableName'] = &$this->_TableName;

		// Permission
		$this->Permission = new cField('user_level_permission', 'user_level_permission', 'x_Permission', 'Permission', '`Permission`', '`Permission`', 3, -1, FALSE, '`Permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`user_level_permission`";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("user_level_permissionview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("user_level_permissionview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "user_level_permissionadd.php?" . $this->UrlParm($parm);
		else
			return "user_level_permissionadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("user_level_permissionedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("user_level_permissionadd.php", $this->UrlParm($parm));
	}
