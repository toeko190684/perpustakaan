...
<?php if ($users->user_id->Visible) { // user_id ?>
		<th><span id="elh_users_user_id" class="users_user_id"><?php echo $users->user_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($users->password->Visible) { // password ?>
		<th><span id="elh_users_password" class="users_password"><?php echo $users->password->FldCaption() ?></span></th>
<?php } ?>
<?php if ($users->level->Visible) { // level ?>
		<th><span id="elh_users_level" class="users_level"><?php echo $users->level->FldCaption() ?></span></th>
<?php } ?>
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_user_id" class="form-group users_user_id">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_password" class="form-group users_password">
...
<span id="el<?php echo $users_delete->RowCnt ?>_users_level" class="form-group users_level">
