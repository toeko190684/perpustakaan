...
<span id="el_users_user_id" class="form-group">
...
<?php if ($users->level->Visible) { // level ?>
	<tr id="r_level">
		<td><span id="elh_users_level"><?php echo $users->level->FldCaption() ?></span></td>
		<td<?php echo $users->level->CellAttributes() ?>>
<span id="el_users_level" class="form-group">
...
<?php if ($users->profile->LinkAttributes() <> "") { ?>
<?php if (!empty($users->profile->Upload->DbValue)) { ?>
<a<?php echo $users->profile->LinkAttributes() ?>><?php echo $users->profile->ViewValue ?></a>
<?php } elseif (!in_array($users->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } else { ?>
<?php if (!empty($users->profile->Upload->DbValue)) { ?>
<?php echo $users->profile->ViewValue ?>
<?php } elseif (!in_array($users->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } ?>
